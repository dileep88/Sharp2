...
namespace Sharp2POC.Core.ViewModels
{
	...
	public class ManageLoadsViewModel : BaseViewModel
	{
		private readonly IMvxNavigationService nav;
		public ManageLoadsViewModel(IMvxNavigationService _nav)
		{
			nav = _nav; 
            ...
            {
                new ManageLoadItem("UPSP1234","09878", () => Task.CompletedTask),
                  new ManageLoadItem("UPSP1234","09878", () => Task.CompletedTask),
                  new ManageLoadItem("UPSP1234","09878", () => Task.CompletedTask),
                  new ManageLoadItem("UPSP1234","09878", () => Task.CompletedTask), 
            });
